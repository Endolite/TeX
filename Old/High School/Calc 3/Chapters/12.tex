...
\begin{document}
	\section{Three-Dimensional Coordinate Systems}
		...
		\subsection*{Components of a Vector}
			\addcontentsline{toc}{subsection}{Components of a Vector}
		...
		\section{The Cross Product}
			\subsection*{The Cross Product of Two Vectors}
				...
				\subsection*{Triple Products}
					\addcontentsline{toc}{subsection}{Triple Products}
						The \textbf{scalar triple product} of vectors $\vec{a}$, $\vec{b}$, and $\vec{c}$ is
							\[
							...
							\]
						\callout{17}{
							The volume of a parallelpiped determined by vectors $\vec{a}$, $\vec{b}$, and $\vec{c}$ is the magnitude of their scalar triple product.
								\[V = |\vec{a} \cdot (\vec{b} \times \vec{c})|\]
						}
						The \textbf{vector triple product} of vectors $\vec{a}$, $\vec{b}$, and $\vec{c}$ is
			...
			\section{Equations of Lines and Planes}
				...
				\subsection*{Distances}
					...
					\callout{17}{
						The distance $D$ from a point $P(x, y, z)$ to a a plane $ax + by + cz + d = 0$ is
