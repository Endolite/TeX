	...
	\chapter{Infinite Series}
		...
		\section{Error}
			\subsection{Actual Error}
				The \textbf{actual error} at $c$ is the difference between a function's actual value at $c$ and that of its $n^{\mathrm{th}}$ Taylor/Maclaurin polynomial.
				\[\mathrm{error} = f(c) - P_n(c)\]
