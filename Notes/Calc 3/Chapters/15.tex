...
\begin{document}
	...
	\section{Applications of Double Integrals}
		...
		\subsection*{Moments and Centers of Mass}
			\addcontentsline{toc}{subsection}{Moments and Centers of Mass}
			...
			\addcontentsline{toc}{subsection}{Triple Integrals in Spherical Coordinates}
				...
				\callout{17}{
					For a spherical wedge $E$ given by
						...
						\[\iiint\limits_E f(x, y, z)\,\d V = \int_\delta^\gamma\int_\alpha^\beta\int_a^b f(\rho\sin\varphi\cos\theta, \rho\sin\varphi\sin\theta, \rho\cos\varphi)\rho^2\sin\varphi\,\d\rho\,\d\theta\,\d\varphi\]
				}
			...
			\subsection*{Change of Variables in Triple Integrals}
				...
				Let $T$ be a one-to-one transformation that maps region $S$ in  $uvw$-space to region $R$ in the $xyz$-space.
					...
					The \textbf{Jacobian} of $T$ is
						...
						\]
					\callout{17}{
						\[\iiint\limits_R f(x, y, z)\,\d V = \iiint\limits_S f(x(u, v, w), y(u, v, w), z(u, v, w))\left|\pder{(x, y, z)}{u, v, w}\right|\d u\,\d v\,\d w\]
					}
\end{document}