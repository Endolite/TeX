...
\begin{document}
	\chapter{One-Variable Quantitative Data}
		...
		\section{Graphically Displaying Distributions}
			...
			\subsubsection{Graphically Describing Distributions}
		...
		\section{Density Curves}
			A \textbf{density curve}, typically denoted $f$, displays the relative frequencies of every possible value of its variable, making it effectively continuous. As such, the total area under the curve must be exactly 1 and its values must always be positive. \\ 
