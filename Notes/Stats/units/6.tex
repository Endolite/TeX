...
\begin{document}
	...
	\chapter{Chi-Square Tests}
		...
		\section{Homogeneity}
			...
			\callout{18.1}{The conditions for a chi-square test for homogeneity are the same as those for one for goodness of fit.}
		\section{Independence}
			...
			\callout{18.2}{
				The conditions for a chi-square test for independence are the same as those for one for goodness of fit.
			}	
