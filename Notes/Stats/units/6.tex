	...
	\chapter{Significance Tests}
		...
		\section{Significance Tests about Proportions}
			...
			\subsection*{Significance Tests about Differences in Proportions}
				...
				\callout{17}{For a significance test to be run about a difference of proportions, the randomness, independence (\emph{10\%}) (for each proportion), and \emph{Large Counts} conditions must be met.}
		...
		\section{Significance Tests about Means}
			\callout{17}{To perform a significance test for a population mean, a \textbf{1-sample $\pmb{t}$ test}, randomness, independence (\emph{10\%}), and Normality (\emph{CLT} or distribution) must be verified.}
